...
<html>
	<head>
	    ...
	    <script src="${resPath}/myPage_event.js?a"></script>
	...
	<body>
           ...
           <div class="headBox">
	        <div class="box1">
	            <a onclick="changeView('update.myPage')" style="display: flex;">
	                <div class="jss1027">
	        ...
	        <div class="box1">
	            <a onclick="changeView('often_seen.myPage')">
	                <div class="boxInA">
	        ...
	        <div class="sideBox">
	            <div class="reviewBox">
	                ...
	                <div class="reviewBtnBox">
	                    ...
	                    <button onclick="changeView()" class="MuiButtonBase-root jss1002" tabindex="0" type="button">
