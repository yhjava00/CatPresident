...
<html>
	<head>
	    ...
	    <script src="${resPath}/myPage_event.js"></script>
			        ...
			        <div class="box1">
			            <a href="#" style="display: flex;">
			                ...
			                <div style="float: left; margin: auto; margin-left: 10px;">
			                    ...
			                    <p style="margin: 5px 0;">email@naver.com</p>
			                </div>
			            </a>
			        </div>
			        <div class="box1">
			            <a href="#">
			                <div class="boxInA">
			                    ...
			                    <strong class="numInBox">0</strong>
				...
				<div class="mainBox">
			        ...
			        <div class="sideBox">
			            <div class="reviewBox">
			                ...
			                <div class="reviewBtnBox">
			                    <button class="MuiButtonBase-root jss1002" tabindex="0" type="button">
			                        <span class="jss1003">작성 가능한</span> 
			                        <span class="jss1004">0</span>
			                        <span class="MuiTouchRipple-root"></span>
			                    </button>
			                    <button class="MuiButtonBase-root jss1002" tabindex="0" type="button">
			                        <span class="jss1003">이미 작성한</span> 
			                        <span class="jss1005">0</span>
			                        <span class="MuiTouchRipple-root"></span>
			                    </button>
			                </div>
			                <div>
			                ...
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">주문취소</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">교확하기</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">반품하기</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			                <div class="jss283">
			                ...
			                <div>
			                    <h3 class="jss1006">나의 지갑</h3>
			                </div>
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">스티커</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">할인쿠폰</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">보유현금</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			                <div class="jss283">
			                    <a class="jss1007" href="#">
			                        <span class="jss288">고대페이</span>
			                        <svg class="jss1008" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="img"><path d="M8.828 12L17.413 20.645 15.999 22.06 6 12 15.999 2.002 17.413 3.417z" transform="matrix(-1 0 0 1 23.413 0)"></path></svg>
			                    </a>
			                </div>
			            </div>
			        ...
			        <div class="contentBox">
			            <main>
			            	${page }
			            	<c:choose>
				            	<c:when test="${page == 'available_reviews'}">
					    			<jsp:include page="myPage_available_reviews.jsp"></jsp:include>
				            	</c:when>
				            	<c:when test="${page == 'often_seen'}">
					    			<jsp:include page="myPage_often_seen.jsp"></jsp:include>
				            	</c:when>
				            	<c:when test="${page == 'orders'}">
					    			<jsp:include page="myPage_orders.jsp"></jsp:include>
				            	</c:when>
				            	<c:when test="${page == 'review'}">
					    			<jsp:include page="myPage_review.jsp"></jsp:include>            
				            	</c:when>
				            	<c:when test="${page == 'login'}">
					    			<jsp:include page="myPage_update_login.jsp"></jsp:include>            
				            	</c:when>
				            	<c:when test="${page == 'update'}">
					    			<jsp:include page="myPage_update.jsp"></jsp:include>            
				            	</c:when>
				            </c:choose>
			            </main>
			        </div>
