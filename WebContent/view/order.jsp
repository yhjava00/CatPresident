	...
	<head>
		...
		<script>
			...
			function order() {
				...
				$('html').scrollTop(0)
				$.ajax({
					url: 'insertOrder.main',
					async : true,
					type : 'post',
					data : {'name':name, 'phone':phone, 'addr1':addr1, 'addr2':addr2, 'addr3':addr3, 'req':req, 'total':total},
					dataType : 'html',
					cache: false
				}).done(function (data) {
        ...
        <div class="a4001">
                                ...
                                <div class="a4082">
		                            ...
		                            <c:forEach var="order" items="${orderList}">                       
                                        <li class="a4088">
                                            <div class="a4089">
                                                <div class="a4090">
                                                	<img class="a4092" src="${order.img}" sizes="auto">
                                                </div>
                                                <div class="a4093">
                                                    <div class="a4094">
                                                        <div class="a4095">
                                                            <h3 class="a4096">${order.name}</h3>
                                                            <div class="a4097">수량 :${order.quantity} 개</div>
                                                        </div>
                                                        <div class="a4098">
                                                            <strong class="a4099"><fmt:formatNumber value="${order.price * order.quantity}"/> 원</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
	        ...
	        <div class="a4163">
	            <p class="a4164">위 주문 내용을 확인하였으며 결제에 동의합니다.</p>
		            <div>
		                <button class="a4165" tabindex="0" type="button" onclick="order()" data-testid="pay"> 
