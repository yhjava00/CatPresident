	...
	<body style="overflow-x: hidden;">
                            ...
                            <div class="a2047-root a2048 a2047-outlined">
                                <c:choose>
                                	<c:when test="${empty loginUser}">
                                		<div class="a2056"><a class="a2003-root a2059-root a2059-contained a2058 undefined a2057 a2059-containedPrimary a2059-fullWidth" tabindex="0" aria-disabled="false"><span onclick="outProduct('loginForm.member')" class="a2059-label">로그인</span><span class="a2060-root"></span></a><a class="a2003-root a2059-root a2059-outlined a2058 a2061 a2057 a2059-colorInherit a2059-fullWidth" tabindex="0" aria-disabled="false"><span onclick="outProduct('Sign_upForm.member')" class="a2059-label">회원가입</span><span class="a2060-root"></span></a></div>
                                	</c:when>
                                	<c:otherwise>
        ...
        <div class="p_a2032">
            <div class="a2034" id = "header2">
                <div class="a2037"></div><a href="index2.html" id="p_category_background"><svg id="p_category" class="a2035" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 122 50">
            ...
            <div id="p_category_list" class="a2045">
                <ul class="a2046">
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/053">사료</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/054">간식</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/055">건강관리</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/056">모래</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/057">화장실/위생</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/058">미용/목욕</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/059">급식기/급수기</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/060">스크래쳐/캣타워</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/061">하우스</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/063">이동장</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/064">의류/액세서리</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/069">목줄/가슴줄</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/065">장난감</a>
                    </li>
                    <li><a class="jss147" role="button" tabindex="0" href="/p_category/070">생활/가전</a>
                    </li>
